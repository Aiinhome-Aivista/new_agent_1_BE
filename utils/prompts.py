...
DOCUMENT_CONTENT_ANALYSIS_PROMPT = ChatPromptTemplate.from_messages([
            ("system", (
                ...
                "Analyze the uploaded document and extract the content into a structured format.\n"
                "Extract only information supported by the uploaded document.\n"
                "Do not invent technologies, costs, timelines, architecture components, client names or business facts.\n"
                "If information for a field is not present in the document, use null or an empty list [].\n\n"
