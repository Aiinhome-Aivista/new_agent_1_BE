    ...
    def analyze_tech_stack(self, text: str, requirements: list) -> dict:
        ...
        prompt = ChatPromptTemplate.from_messages([
            ("system", (
                ...
                "- Option 1: The Primary/Recommended stack (ideally matching any technologies explicitly requested in the document, or falling back to the best stack for that application type).\n"
                "- Option 2: An alternative stack (different UI or backend framework, e.g. switching React Native for Flutter, or NestJS for Flask).\n"
                "- Option 3: A lightweight or enterprise-heavy alternative stack (e.g., a Go-based API or a Spring Boot/Java enterprise setup).\n\n"
