    ...
    def analyze_tech_stack(self, text: str, requirements: list) -> dict:
        ...
        prompt = ChatPromptTemplate.from_messages([
            ("system", (
                ...
                "- If the document explicitly mentions specific AI model names (e.g. Llama 3, GPT-4), you MUST extract and return EXACTLY those mentioned models, and do not add arbitrary suggestions.\n"
                "- If no specific models are mentioned, recommend exactly 4-5 strings representing the best AI models for this specific stack.\n"
                "- VERY IMPORTANT SORTING RULE: You MUST always sort the final 'ai_models' list so that FREE / OPEN-SOURCE models (e.g. Llama, Mistral, Gemma, Cohere, HuggingFace models) appear FIRST at the top of the list, followed by paid/proprietary models (e.g. GPT-4, Claude). You MUST append ' and above' to each model name.\n\n"
                ...
                "   - 'ui': UI / Frontend / Mobile technology slug\n"
                "   - 'backend': Backend technology or API framework slug\n"
                "   - 'database': Database / Datastore / Cache / Warehouse technology slug\n"
